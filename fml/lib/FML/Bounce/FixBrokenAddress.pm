...
package FML::Bounce::FixBrokenAddress;
...
FML::Bounce::FixBrokenAddress - fix invalid address.
...
FML::Bounce::FixBrokenAddress first appeared in fml8 mailing list driver package.
