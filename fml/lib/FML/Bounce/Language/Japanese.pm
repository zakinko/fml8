...
package FML::Bounce::Language::Japanese;
...
FML::Bounce::Language::Japanese - Japanese dependent error message parser.
...
FML::Bounce::Language::Japanese first appeared in fml8 mailing list driver package.
