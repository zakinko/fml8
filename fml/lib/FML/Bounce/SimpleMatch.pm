...
#
# $FML: SimpleMatch.pm,v 1.44 2005/08/19 12:18:12 fukachan Exp $
#


package FML::Bounce::SimpleMatch;

use strict;
use vars qw(@ISA @EXPORT @EXPORT_OK $AUTOLOAD);
use Carp;

use FML::Bounce::Language::Japanese;
@ISA = qw(
	FML::Bounce
	FML::Bounce::Language::Japanese
	  );

=head1 NAME

FML::Bounce::SimpleMatch - simple state machine to parse error messages.

=head1 SYNOPSIS

See C<FML::Bounce> for more details.

=head1 DESCRIPTION

subclass used in C<FML::Bounce>.
...
sub analyze
{
	...
	if ($debug) { print STDERR "   paragraph_total: $total\n";}
...
FML::Bounce::SimpleMatch first appeared in fml8 mailing list driver package.
