...
#
# $FML: Freeserve.pm,v 1.7 2005/05/26 13:12:42 fukachan Exp $
#
...
FML::Bounce::Freeserve - Freeserve error message format parser.
...
See L<FML::Bounce::Language::Japanese> module for the Japanese
message.
...
FML::Bounce::Freeserve first appeared in fml8 mailing list driver package.
