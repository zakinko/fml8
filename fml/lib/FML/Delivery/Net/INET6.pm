...
package FML::Delivery::Net::INET6;
use strict;
...
FML::Delivery::Net::INET6 - establish tcp connection over IPv6.
...
over IPv6. It is used within L<FML::Delivery::SMTP> module.
...
FML::Delivery::Net::INET6 first appeared in fml8 mailing list driver package.
