...
package FML::Delivery::Net::INET4;
use strict;
...
FML::Delivery::Net::INET4 - establish tcp connection over IPv4.
...
FML::Delivery::Net::INET4 first appeared in fml8 mailing list driver package.
