...
FML::Delivery - top level mail delivery system interface.
...
=head1 SYNOPSIS
    ...
    # specify FML::IO::Adapter parameters if needed.
    $map_params = {
	'mysql:toymodel' => {
...
almost same as C<FML::Delivery::SMTP> class.
Please see it for more details.

=head1 DESCRIPTION

In C<FML::Delivery> class,
...
#               return object such as FML::Delivery::ESMTP.
...
FML::Delivery first appeared in fml8 mailing list driver package.
