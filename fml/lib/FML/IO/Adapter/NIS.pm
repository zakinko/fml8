...
FML::IO::Adapter::NIS - NIS map operations.
...
This class inherits C<FML::IO::Adapter::Array>.
See L<FML::IO::Adapter::Array>.
...
FML::IO::Adapter::NIS first appeared in fml8 mailing list driver package.
