...
use FML::IO::Adapter::File;
push(@ISA, 'FML::IO::Adapter::File');


=head1 NAME

FML::IO::Adapter::PCRE - IO functions for a pcre file.
...
FML::IO::Adapter::PCRE first appeared in fml8 mailing list driver package.
