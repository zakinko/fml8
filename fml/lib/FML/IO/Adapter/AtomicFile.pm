...
package FML::IO::Adapter::AtomicFile;
use strict;
...
FML::IO::Adapter::AtomicFile - atomic IO operation.

=head1 SYNOPSIS

    use FML::IO::Adapter::AtomicFile;
    my $wh = FML::IO::Adapter::AtomicFile->open($file);
    if (defined $wh) {
...
To copy from $src to $dst,
    ...
    FML::IO::Adapter::AtomicFile->copy($src, $dst) || croak("fail to copy");
...
C<FML::IO::Adapter::AtomicFile::rw_open>.
...
FML::IO::Adapter::AtomicFile first appeared in fml8 mailing list driver package.
