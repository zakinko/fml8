...
FML::IO::Adapter::Array - base class for IO emulation for ARRAY_REF.
...
=head1 SYNOPSIS
    ...
    $obj = new FML::IO::Adapter::Array $map;
    $obj->open;
...
FML::IO::Adapter::Array first appeared in fml8 mailing list driver package.
