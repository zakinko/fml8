...
package FML::IO::Adapter::PostgreSQL;
...
FML::IO::Adapter::PostgreSQL - interface to talk with a PostgreSQL server.
...
FML::IO::Adapter::PostgreSQL specific configuration loader.
