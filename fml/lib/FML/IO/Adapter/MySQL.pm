...
#          All rights reserved.
#
# $FML: MySQL.pm,v 1.29 2005/08/23 08:34:52 fukachan Exp $
#


package FML::IO::Adapter::MySQL;
...
use FML::IO::Adapter::DBI;
push(@ISA, 'FML::IO::Adapter::DBI');


=head1 NAME

FML::IO::Adapter::MySQL - interface to talk with a MySQL server.
...
=head1 SYNOPSIS
   ...
   my $obj = new FML::IO::Adapter ($map, $map_params);
   $obj->open();
...
This module inherits C<FML::IO::Adapter::DBI> class.

The model dependent SQL statement is expected to be holded in
C<FML::IO::Adapter::SQL::> modules.
...
FML::IO::Adapter::MySQL specific configuration loader.
It also calles FML::IO::Adapter::SQL::$model module for model specific
...
sub configure
{
    ...
    for my $host (@hosts) {
	use FML::IO::Adapter::DBI;
	my $dsn = FML::IO::Adapter::DBI->make_dsn( {
	    driver   => 'mysql',
...
FML::IO::Adapter::File first appeared in fml8 mailing list driver package.
