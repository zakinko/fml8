...
package FML::IO::Adapter::ErrorStatus;
...
FML::IO::Adapter::ErrorStatus - error handling component.
...
Use this module in your C<Something> class module like this:
   ...
   package Something;
   use FML::IO::Adapter::ErrorStatus qw(errstr error error_set error_clear);
...
FML::IO::Adapter::ErrorStatus first appeared in fml8 mailing list driver package.
