...
FML::IO::Adapter::LDAP - abstracted IO interface for LDAP.

=head1 SYNOPSIS

   use FML::IO::Adapter;
   my $obj = new FML::IO::Adapter "ldap:fml", $map_params;
   $obj->open();
...
FML::IO::Adapter::LDAP specific configuration loader.
...
FML::IO::Adapter::LDAP first appeared in fml8 mailing list driver package.
